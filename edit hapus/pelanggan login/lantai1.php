...
<html>
    ...
    <body>
        <div class="center">
            <div class="container">
                <div class="contain">
                    <a href="/smakir/pelanggan/logout.php" class="btn logout">LOGOUT</a>
                    </br>
                    </br>
                    <?php
                        session_start(); 
                        echo "<p>Halo, Selamat Datang Mobil <b>".$_SESSION['plat'];
                    ?>
                    </br>
                    </br>
                    <div class="navbar">
                        <h5>Pilih Lantai</h5>
                        <a href="#" class="btn lantai"><span>Lantai 2</span></a>
                        <a href="#" class="btn lantai"><span>Lantai 3</span></a>
                        <a href="#" class="btn lantai"><span>Lantai 4</span></a>
                        <a href="#" class="btn lantai"><span>Lantai 5</span></a>                       
                    </div>
                    </br>
                ...
                <div class="content">
                    <div class="left-content">
                        ...
                        <div class="sisi">
                            <h5>Sisi Kiri</h5>
                            <a href="#" class="btn refresh"><span>refresh</span></a> 
                        </div>
